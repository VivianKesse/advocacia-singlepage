...
export default function App() {
  return (
    <>
      ...
      <main className="bg-[url('/assets/balanca.png')] bg-cover h-screen bg-right bg-no-repeat bg-fixed flex items-center justify-center shadow-mainBlue">
      ...
      <section id="about" className="flex  min-h-screen justify-center items-center gap-10 px-2 py-5 flex-col lg:grid lg:grid-cols-2 md:p-10 ">
        ...
        <div className="w-[80%] md:w-1/2 lg:w-full">
          <img src="/assets/group.jpg" alt="Imagem de uma equipe" className="m-auto z-2 lg:w-full rounded-lg shadow-[10px_10px_0px_0px_#99743F]" />
        </div>
      ...
      <section id="how" className="min-h-screen bg-mainBlue p-2 md:p-10">
        ...
        <div className="flex flex-col items-center justify-center gap-4 md:grid md:grid-cols-2 md:gap-5 lg:grid-cols-3">
          ...
          <Law title="Direito de Família" text="Atuamos em processos de divórcio, guarda de filhos, pensão alimentícia e partilha de bens, sempre com sensibilidade e discrição." img="/assets/familia.svg" />

          <Law title="Direito Penal" text="Garantimos defesa eficiente e imparcial em processos criminais, zelando pelos seus direitos fundamentais." img="/assets/criminal.svg" />

          <Law title="Direito Trabalhista" text="Defendemos seus direitos como trabalhador ou empregador, garantindo soluções justas para questões trabalhistas." img="/assets/trabalhista.svg" />

          <Law title="Direito Civil" text="Oferecemos suporte em contratos, indenizações, direitos do consumidor e outros assuntos relacionados." img="/assets/civil.svg" />

          <Law title="Direito Empresarial" text="Ajudamos empresas com questões legais, desde contratos e compliance até disputas judiciais." img="/assets/empresarial.svg" />

          <Law title="Direito Imobiliário" text="Assessoramos compra, venda, regularização e conflitos relacionados a imóveis." img="/assets/imobiliario.svg" />
        </div>
      ...
      <section className="bg-[url('/assets/martelo.png')] bg-cover bg-no-repeat bg-center p-2 flex flex-col gap-5 md:flex-row md:flex md:p-10">
        ...
        <div className="bg-mainYellow text-mainWhite p-3 w-[90%] m-auto rounded-lg md:w-[50%] lg:w-[40%] ">
          <div className="flex items-baseline justify-center gap-2">
            <img className="h-5" src="/assets/balanca-icone.svg" alt="ícone de balança" />
